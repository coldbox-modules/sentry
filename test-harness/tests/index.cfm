...
<div id="tb-runner" class="container">
	...
	<div class="row">
		<div class="col-md-4 text-center mx-auto">
			...
			<br>
			<a
				href="/tests/index.cfm?action=runTestBox&path=#URLEncodedFormat( url.path )#"
				target="_blank"
			>
				<button
		...
		<div class="col-md-12">
			<form name="runnerForm" id="runnerForm">
				...
				<fieldset>
					...
					<cfif len( url.path )>
						<a href="/tests/index.cfm?path=#URLEncodedFormat( backPath )#">
					...
					<cfloop query="qResults">
						...
						<cfif qResults.type eq "Dir">
							<a
								...
								href="/tests/index.cfm?path=#urlEncodedFormat( url.path & "/" & qResults.name )#"
							>
								&##x271A; #qResults.name#
							</a>
							<br />
